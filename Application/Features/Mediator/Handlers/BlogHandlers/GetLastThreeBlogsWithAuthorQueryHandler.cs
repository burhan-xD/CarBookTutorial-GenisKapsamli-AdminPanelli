...
{
    public class GetLastThreeBlogsWithAuthorQueryHandler : IRequestHandler<GetLastThreeBlogsWithAuthorQuery, List<GetLastThreeBlogsWithAuthorQueryResult>>
    {
        private readonly IBlogRepository _blogRepository;

        public GetLastThreeBlogsWithAuthorQueryHandler(IBlogRepository blogRepository)
        {
        ...
        {
            var values = _blogRepository.GetLastThreeBlogsWithAuthor();
